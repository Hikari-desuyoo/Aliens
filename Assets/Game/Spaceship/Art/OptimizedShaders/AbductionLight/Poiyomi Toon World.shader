Shader "Hidden/Locked/.poiyomi/Poiyomi Toon World/e6adc33e0a990e54aa58a127bbb1604e"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (-0.03 /*_AlphaMod*/));
				...
				if ((1.0 /*_AlphaDistanceFade*/))
				{
					...
					float distanceFadeMultiplier = lerp((0.0 /*_AlphaDistanceFadeMinAlpha*/), (1.0 /*_AlphaDistanceFadeMaxAlpha*/), smoothstep((0.0 /*_AlphaDistanceFadeMin*/), (6.0 /*_AlphaDistanceFadeMax*/), distance(position, poiCam.worldPos)));
				...
				{
					float holoRim = saturate(1 - smoothstep(min(_AlphaFresnelSharpness, (1.0 /*_AlphaFresnelWidth*/)), (1.0 /*_AlphaFresnelWidth*/), (poiCam.vDotN)));
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength1 = (1.3 /*_EmissionStrength1*/);
				...
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(0.9816965,1.741101,0.9608907,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(0.9816965,1.741101,0.9608907,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(0.9816965,1.741101,0.9608907,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,1,0.2421678,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0,1,0.2421678,1).a;
				#if defined(PROP_ALPHAMASK) || !defined(OPTIMIZER_ENABLED)
				if ((2.0 /*_MainAlphaMaskMode*/))
				{
					float alphaMask = POI2D_SAMPLER_PAN(_AlphaMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_AlphaMaskUV*/)], float4(1,1,0,0)), float4(0.21,0,0,0).xy).r;
